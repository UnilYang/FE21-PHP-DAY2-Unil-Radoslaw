...
<input  type="submit"  name="submitget"  />
    ...
    Use the POST method. If the length of your name is larger than 5 characters, 
    change the text colour to green. Otherwise, 
...
{
    if($_GET["hobbies"])
        echo "<div>Hobbies are: " . $_GET["hobbies"] . "</div><br>";
}
